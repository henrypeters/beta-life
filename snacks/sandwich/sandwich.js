...
recheck.innerHTML = `<a href="sandwich.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of sandwich <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="sandwich.html"><img src="../../images/socials/delete.png"></a>`;
