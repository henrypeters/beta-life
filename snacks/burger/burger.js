...
recheck.innerHTML = `<a href="burger.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of burger <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="burger.html"><img src="../../images/socials/delete.png"></a>`;
