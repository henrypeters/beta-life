...
recheck.innerHTML = `<a href="rigate.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of rigate <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="rigate.html"><img src="../../images/socials/delete.png"></a>`;
