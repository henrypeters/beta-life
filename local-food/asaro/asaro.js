...
recheck.innerHTML = `<a href="asaro.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of asaro <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="asaro.html"><img src="../../images/socials/delete.png"></a>`;
