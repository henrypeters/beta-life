...
recheck.innerHTML = `<a href="egusi.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of egusi <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="egusi.html"><img src="../../images/socials/delete.png"></a>`;
