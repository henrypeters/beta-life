...
function addLinkMenu() {
    ...
    designLink3.innerHTML = `<div><a href="../pop-corn/popCorn-select.html" class="linkTag">${link3}</a></div>`;
...
recheck.innerHTML = `<a href="chocoPopcorn.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` pack of chocolate popcorn <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="chocoPopcorn.html"><img src="../../images/socials/delete.png"></a>`;
...
function setCard() {
    ...
    listHolder.innerHTML = `<li><a class="readonlyLink">Home</a></li>
                            ...
                            <li><a class="readonlyLink">Select Popcorn</a></li>`;
    designGreet.innerHTML = `<h3 class="greet"> ${greet} </h3>`;
    designPlate.innerHTML = `<h2> ${logicForNumPlate += plate} </h2>`;
    designTime.innerHTML = `<h3 class="designTime"> ${notifyTime} </h3>`;
    displayTime.innerHTML = `<h2> ${input2.value} </h2> <hr class="notify-line">`;
