...
recheck.innerHTML = `<a href="cookies.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` pack of cookies <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="cookies.html"><img src="../../images/socials/delete.png"></a>`;
