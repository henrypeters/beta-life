...
recheck.innerHTML = `<a href="amala.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of amala <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="amala.html"><img src="../../images/socials/delete.png"></a>`;
