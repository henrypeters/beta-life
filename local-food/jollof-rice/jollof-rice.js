...
recheck.innerHTML = `<a href="jollof-rice.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of jollof rice <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="jollof-rice.html"><img src="../../images/socials/delete.png"></a>`;
