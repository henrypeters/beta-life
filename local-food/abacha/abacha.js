...
recheck.innerHTML = `<a href="abacha.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of abacha <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="abacha.html"><img src="../../images/socials/delete.png"></a>`;
