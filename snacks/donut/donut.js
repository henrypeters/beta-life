...
recheck.innerHTML = `<a href="donut.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of donut <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="donut.html"><img src="../../images/socials/delete.png"></a>`;
