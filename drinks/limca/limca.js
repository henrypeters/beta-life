...
recheck.innerHTML = `<a href="limca.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of limca <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="limca.html"><img src="../../images/socials/delete.png"></a>`;
