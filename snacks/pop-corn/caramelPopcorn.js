...
recheck.innerHTML = `<a href="caramelPopcorn.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` pack of caramel popcorn <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="caramelPopcorn.html"><img src="../../images/socials/delete.png"></a>`;
