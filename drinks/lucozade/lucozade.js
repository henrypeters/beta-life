...
recheck.innerHTML = `<a href="lucozade.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of lucozade <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="lucozade.html"><img src="../../images/socials/delete.png"></a>`;
