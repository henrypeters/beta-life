...
recheck.innerHTML = `<a href="gnoochi.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of gnoochi <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="gnoochi.html"><img src="../../images/socials/delete.png"></a>`;
