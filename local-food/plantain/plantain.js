...
recheck.innerHTML = `<a href="plantain.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of plantain <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="plantain.html"><img src="../../images/socials/delete.png"></a>`;
