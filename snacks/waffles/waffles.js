...
recheck.innerHTML = `<a href="waffles.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of waffles <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="waffles.html"><img src="../../images/socials/delete.png"></a>`;
