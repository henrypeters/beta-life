...
recheck.innerHTML = `<a href="macaroni.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    removeButton.innerHTML = `<a href="macaroni.html"><img src="../../images/socials/delete.png"></a>`;
