...
recheck.innerHTML = `<a href="mirinda.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of mirinda <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="mirinda.html"><img src="../../images/socials/delete.png"></a>`;
