...
// recheck.innerHTML = `<a href="fusilli.html"><button> Recheck my order </button></a>`;
...
//     let plate = ` plate of fusilli <hr class="notify-line">`;
...
function setCardMinimal() {
    ...
    removeButton.innerHTML = `<a href="fusilli.html"><img src="../../images/socials/delete.png"></a>`;
