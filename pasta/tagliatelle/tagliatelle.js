...
recheck.innerHTML = `<a href="tagliatelle.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of tagliatelle <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="tagliatelle.html"><img src="../../images/socials/delete.png"></a>`;
