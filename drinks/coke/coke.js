...
recheck.innerHTML = `<a href="coke.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of coke <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="coke.html"><img src="../../images/socials/delete.png"></a>`;
