...
recheck.innerHTML = `<a href="ogbono.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of ogbono <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="ogbono.html"><img src="../../images/socials/delete.png"></a>`;
