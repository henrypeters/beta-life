...
recheck.innerHTML = `<a href="hot-dog.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of hot dog <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="hot-dog.html"><img src="../../images/socials/delete.png"></a>`;
