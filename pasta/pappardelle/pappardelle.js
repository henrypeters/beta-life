...
recheck.innerHTML = `<a href="pappardelle.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    removeButton.innerHTML = `<a href="pappardelle.html"><img src="../../images/socials/delete.png"></a>`;
