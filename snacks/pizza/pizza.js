...
recheck.innerHTML = `<a href="pizza.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of pizza <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="pizza.html"><img src="../../images/socials/delete.png"></a>`;
