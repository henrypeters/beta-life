...
recheck.innerHTML = `<a href="lacasera.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of lacasera <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="lacasera.html"><img src="../../images/socials/delete.png"></a>`;
