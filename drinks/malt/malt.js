...
recheck.innerHTML = `<a href="malt.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of malt <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="malt.html"><img src="../../images/socials/delete.png"></a>`;
