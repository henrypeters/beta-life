...
recheck.innerHTML = `<a href="efo-riro.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of efo riro <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="efo-riro.html"><img src="../../images/socials/delete.png"></a>`;
