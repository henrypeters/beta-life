...
recheck.innerHTML = `<a href="ukpo-oka.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of ukpo oka <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="ukpo-oka.html"><img src="../../images/socials/delete.png"></a>`;
