...
recheck.innerHTML = `<a href="chips.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` pack of chips <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="chips.html"><img src="../../images/socials/delete.png"></a>`;
