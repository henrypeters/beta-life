...
recheck.innerHTML = `<a href="fanta.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of fanta <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="fanta.html"><img src="../../images/socials/delete.png"></a>`;
