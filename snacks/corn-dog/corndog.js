...
recheck.innerHTML = `<a href="corndog.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of corndog <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="corndog.html"><img src="../../images/socials/delete.png"></a>`;
