...
recheck.innerHTML = `<a href="radiatore.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of radiatore <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="radiatore.html"><img src="../../images/socials/delete.png"></a>`;
