...
recheck.innerHTML = `<a href="shawarma.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` piece of shawarma <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="shawarma.html"><img src="../../images/socials/delete.png"></a>`;
