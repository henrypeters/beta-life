...
recheck.innerHTML = `<a href="indomie.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of indomie <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="indomie.html"><img src="../../images/socials/delete.png"></a>`;
