...
recheck.innerHTML = `<a href="pepsi.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` bottle of pepsi <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="pepsi.html"><img src="../../images/socials/delete.png"></a>`;
