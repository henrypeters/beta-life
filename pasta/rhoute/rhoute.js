...
recheck.innerHTML = `<a href="rhuote.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of rhoute <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="rhuote.html"><img src="../../images/socials/delete.png"></a>`;
