...
recheck.innerHTML = `<a href="orzo.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of orzo <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="orzo.html"><img src="../../images/socials/delete.png"></a>`;
