...
recheck.innerHTML = `<a href="boli.html"><button> Recheck my order </button></a>`;
...
function setCardMinimal() {
    ...
    let plate = ` plate of boli <hr class="notify-line">`;
    ...
    removeButton.innerHTML = `<a href="boli.html"><img src="../../images/socials/delete.png"></a>`;
